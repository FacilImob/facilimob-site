export const dynamicPageStyles = `
  ...
  .dynamic-page h1, .dynamic-page h2, .dynamic-page h3 { letter-spacing: 0; }
  [data-render-id="home_header"] { background: rgba(255,255,255,.94); border-bottom: 1px solid rgba(217,226,236,.8); padding: 0 24px; }
  [data-render-id="home_header_row"] { align-items: center; gap: 28px; min-height: 76px; }
  [data-render-id="home_header_logo"] .dynamic-image-wrap,
  [data-render-id="home_header_nav"] .dynamic-html,
  [data-render-id="home_hero_photo"],
  [data-render-id="home_hero_card"] .dynamic-text:last-child,
  [data-render-id="home_footer_logo"],
  [data-render-id="home_footer_links"] { margin-bottom: 0; }
  [data-render-id="home_header_logo"] .dynamic-image { height: 48px; object-fit: contain; width: auto; }
  [data-render-id="home_header_nav"] .dynamic-html { min-height: 64px; }
  [data-render-id="home_hero"] { background: linear-gradient(90deg, rgba(0, 93, 163, 0.08), rgba(244, 119, 11, 0.06)), #f6f8fb; padding: 56px 24px 44px; }
  [data-render-id="home_hero_row"] { align-items: center; gap: clamp(32px, 5vw, 76px); min-height: calc(100vh - 76px); }
  [data-render-id="home_hero_text"] { max-width: 560px; }
  [data-render-id="home_hero_text"]::before { background: #f4770b; border-radius: 999px; content: ""; display: block; height: 8px; margin-bottom: 28px; width: 86px; }
  [data-render-id="home_hero_title"] { font-size: clamp(42px, 5vw, 68px); line-height: 1; margin-bottom: 24px; }
  [data-render-id="home_hero_copy"] { font-size: 20px; line-height: 1.5; max-width: 620px; }
  [data-render-id="home_hero_cta"],
  [data-render-id="home_hero_whatsapp"] { display: inline-block; margin-right: 12px; margin-top: 12px; width: auto; }
  [data-render-id="home_hero_cta"] .dynamic-button,
  [data-render-id="home_final_cta_btn"] .dynamic-button { font-weight: 800; min-height: 46px; padding: 12px 18px; }
  [data-render-id="home_hero_whatsapp"] .dynamic-button { background: #fff; border: 1px solid #d9e2ec; color: #003f75; font-weight: 800; min-height: 46px; padding: 12px 18px; }
  [data-render-id="home_trust"] { margin-top: 16px; }
  [data-render-id="home_hero_image"] { max-width: 520px; position: relative; }
  [data-render-id="home_hero_photo"] .dynamic-image { aspect-ratio: 4 / 5; border: 1px solid rgba(0,93,163,.16); box-shadow: 0 24px 70px rgba(0,63,117,.16); object-fit: cover; width: 100%; }
  [data-render-id="home_hero_card"] { border-left: 5px solid #f4770b; bottom: 28px; box-shadow: 0 18px 40px rgba(31,42,55,.18); left: -26px; margin: 0; max-width: 260px; position: absolute; z-index: 2; }
  [data-render-id="home_intro"],
  [data-render-id="home_steps"],
  [data-render-id="home_faq"],
  [data-render-id="home_contact"] { padding: 86px 24px; }
  [data-render-id="home_intro_row"],
  [data-render-id="home_contact_row"] { align-items: flex-start; gap: 40px; }
  [data-render-id="home_features_heading"],
  [data-render-id="home_steps_heading"],
  [data-render-id="home_audience_heading"],
  [data-render-id="home_testimonials_heading"],
  [data-render-id="home_faq_heading"] { margin-bottom: 34px; max-width: 720px; }
  [data-render-id$="_eyebrow"],
  [data-render-id="home_tenant_kicker"],
  [data-render-id="home_owner_kicker"] { font-size: 13px; font-weight: 900; line-height: 1.3; text-transform: uppercase; }
  [data-render-id$="_title"] { line-height: 1.05; }
  [data-render-id="home_intro_title"],
  [data-render-id="home_features_title"],
  [data-render-id="home_steps_title"],
  [data-render-id="home_audience_title"],
  [data-render-id="home_testimonials_title"],
  [data-render-id="home_faq_title"],
  [data-render-id="home_contact_title"] { font-size: clamp(30px, 4vw, 48px); }
  [data-render-id="home_signal_card"] { align-items: center; box-shadow: 0 12px 34px rgba(0,63,117,.1); display: grid; gap: 18px; grid-template-columns: 74px 1fr; }
  [data-render-id="home_signal_icon"] .dynamic-image { height: 74px; object-fit: contain; width: 74px; }
  [data-render-id="home_features"],
  [data-render-id="home_testimonials"] { background: #fff; padding: 86px 24px; }
  [data-render-id="home_features_cards"],
  [data-render-id="home_testimonials_cards"] { gap: 18px; }
  [data-render-id="feature_1"],
  [data-render-id="feature_2"],
  [data-render-id="feature_3"],
  [data-render-id="step_1"],
  [data-render-id="step_2"],
  [data-render-id="step_3"],
  [data-render-id="step_4"],
  [data-render-id="testimonial_1"],
  [data-render-id="testimonial_2"],
  [data-render-id="testimonial_3"] { box-shadow: 0 8px 26px rgba(31,42,55,.06); min-height: 100%; }
  [data-render-id="feature_1"],
  [data-render-id="feature_2"],
  [data-render-id="feature_3"] { background: #f6f8fb; border: 1px solid #d9e2ec; display: grid; gap: 14px; padding: 28px; }
  [data-render-id="feature_1"] .dynamic-image,
  [data-render-id="feature_2"] .dynamic-image,
  [data-render-id="feature_3"] .dynamic-image { height: 74px; object-fit: cover; width: 74px; }
  [data-render-id="home_stats"] { background: #003f75; padding: 0 24px; }
  [data-render-id="home_stats_row"] { background: #003f75; gap: 1px; }
  [data-render-id="home_stat_1"],
  [data-render-id="home_stat_2"],
  [data-render-id="home_stat_3"] { background: linear-gradient(135deg, rgba(255,255,255,.08), rgba(255,255,255,.02)); min-height: 150px; padding: 30px; }
  [data-render-id$="_num"] { font-size: clamp(34px, 5vw, 56px); font-weight: 900; line-height: 1; }
  [data-render-id="home_steps_cards"] { gap: 16px; }
  [data-render-id="step_1"],
  [data-render-id="step_2"],
  [data-render-id="step_3"],
  [data-render-id="step_4"] { background: #fff; border: 1px solid #d9e2ec; display: grid; gap: 0; padding: 22px; }
  [data-render-id$="_badge"] { height: 38px; margin-bottom: 20px; width: 38px; }
  [data-render-id$="_badge"] .dynamic-html { min-height: 38px; }
  [data-render-id$="_badge"] iframe { height: 38px; min-height: 38px; }
  [data-render-id="home_audience"] { background: #e8f3fb; padding: 86px 24px; }
  [data-render-id="home_audience_heading"] { margin-bottom: 34px; }
  [data-render-id="home_audience_panels"] { gap: 18px; }
  [data-render-id="home_tenant_card"],
  [data-render-id="home_owner_card"] { border-top: 6px solid #005da3; box-shadow: 0 10px 34px rgba(31,42,55,.08); display: grid; gap: 18px; padding: 34px; }
  [data-render-id="home_owner_card"] { border-top-color: #f4770b; }
  [data-render-id="home_tenant_title"],
  [data-render-id="home_owner_title"] { font-size: 30px; line-height: 1.08; }
  [data-render-id="home_testimonials"] { background: linear-gradient(90deg, rgba(0,93,163,.08), rgba(244,119,11,.05)), #fff; }
  [data-render-id="testimonial_1"],
  [data-render-id="testimonial_2"],
  [data-render-id="testimonial_3"] { padding: 26px; }
  [data-render-id="home_faq_html"] .dynamic-html { min-height: 390px; }
  [data-render-id="home_final_cta"] { background: #003f75; padding: 44px 24px; }
  [data-render-id="home_final_cta_row"] { align-items: center; }
  [data-render-id="home_final_cta_button"] { text-align: right; }
  [data-render-id="home_contact_form"] .dynamic-html { min-height: 470px; }
  [data-render-id="home_contact_email"] .dynamic-button,
  [data-render-id="home_contact_whatsapp"] .dynamic-button { background: transparent; color: #005da3; font-weight: 850; min-height: 0; padding: 0; }
  [data-render-id="home_footer"] { border-top: 1px solid #d9e2ec; padding: 30px 24px; }
  [data-render-id="home_footer_row"] { align-items: center; }
  [data-render-id="home_footer_col"] { align-items: center; display: flex; gap: 20px; justify-content: space-between; }
  [data-render-id="home_footer_col"] > * { flex: 0 1 auto; }
  [data-render-id="home_footer_copy"] { margin-bottom: 0; }
  @media (max-width: 760px) { .dynamic-row { flex-direction: column; } }
  @media (max-width: 980px) {
    [data-render-id="home_hero_row"],
    [data-render-id="home_intro_row"],
    [data-render-id="home_contact_row"],
    [data-render-id="home_final_cta_row"] { flex-direction: column; min-height: auto; }
    [data-render-id="home_hero_text"],
    [data-render-id="home_hero_image"] { max-width: none; width: 100%; }
    [data-render-id="home_hero_photo"] .dynamic-image { aspect-ratio: 16 / 11; }
    [data-render-id="home_hero_card"] { bottom: 16px; left: 16px; }
  }
  @media (max-width: 640px) {
    [data-render-id="home_header_logo"] .dynamic-image { height: 38px; }
    [data-render-id="home_hero_title"] { font-size: 40px; }
    [data-render-id="home_hero_copy"],
    [data-render-id="home_intro_copy"],
    [data-render-id="home_contact_text"] { font-size: 17px; }
    [data-render-id="home_intro"],
    [data-render-id="home_features"],
    [data-render-id="home_steps"],
    [data-render-id="home_audience"],
    [data-render-id="home_testimonials"],
    [data-render-id="home_faq"],
    [data-render-id="home_contact"] { padding: 58px 20px; }
    [data-render-id="home_signal_card"],
    [data-render-id="home_footer_col"] { display: grid; grid-template-columns: 1fr; }
  }
`;
